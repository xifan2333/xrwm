...
4. Review-Fix Loop: Ingest CodeRabbit `Prompt for AI Agents` and Greptile architectural alerts -> defensively verify & commit fixes -> verify `gh pr checks` -> squash merge.
